                                    ...
                                    <div class="center-nav">
                                        <ul>
                                            <li>
                                                ...
                                                <div class="list">
                                                    <p>
                                                        <router-link to="/site/myOrder" class="router-link-exact-active ">
                                    ...
                                    <div class="table-wrap">
                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ftable">
                                            <tbody>
                                                ...
                                                <tr v-for="item in myOrderData.message" :key="item.id">
                                                    <td>{{item.order_no}}</td>
                                                    ...
                                                    <td align="left">{{item.payment_time | dateFmt('YYYY-MM-DD HH:mm:ss')}}</td>
                                                    <td align="left">
                                                        {{item.statusName}}
                                                    </td>
                                                    <td align="left">
                                                        ...
                                                        <br>
                                                        <router-link v-if="item.status==1" :to="'/site/payOrder/'+item.id">|去付款</router-link>
                                                        <br>
